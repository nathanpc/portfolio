...
<p>Recently I bought a couple of those <a href="<?= blog_asset('extension.jpg') ?>">super ultra cheap cigarette plug extensions</a> to distribute 12V in the lab for various things. As usual with everything chinese, I decided to open it up to see how horrible it was inside, but I also did that to upgrade the wiring since I would be pulling a couple of amps from this and I want to minimize the voltage drop.</p>

<?= blog_image("thing.jpg", "The thing") ?>
