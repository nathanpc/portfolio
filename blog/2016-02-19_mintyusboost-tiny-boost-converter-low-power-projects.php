<?php
$post = array(
	'title' => 'MintyUSBoost: A tiny boost converter for low power projects'
);
?>

<?= blog_image("final.jpg", "The MintyUSBoost in its fitting enclosure") ?>
...
<?= blog_image("schematic.png", "Schematic of Rev A") ?>
...
<?= blog_image("noise-scope.png", "Noise Figures") ?>
