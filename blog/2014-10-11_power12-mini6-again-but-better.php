<?php
$post = array(
	'title' => 'Power12: The Mini6 Again, But Better'
);
?>

<?= blog_image("lid-open.jpg", "Amplifier with the lid open") ?>
...
<?= blog_image("no-heatsinks.jpg", "Board without heatsinks") ?>
...
<?= blog_image("enclosure.jpg", "Amplifier enclosure") ?>
...
<?= blog_image("back-panel.jpg", "Back panel") ?>
...
<?= blog_image("thd.png", "THD plot from 20Hz to 20kHz") ?>
...
<?= blog_image("temp-profile.png", "Temperature profile") ?>
