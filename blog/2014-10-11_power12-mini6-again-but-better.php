...
<?= $this->image("lid-open.jpg", "Amplifier with the lid open") ?>
...
<?= $this->image("no-heatsinks.jpg", "Board without heatsinks") ?>
...
<?= $this->image("enclosure.jpg", "Amplifier enclosure") ?>
...
<?= $this->image("back-panel.jpg", "Back panel") ?>
...
<?= $this->image("thd.png", "THD plot from 20Hz to 20kHz") ?>
...
<?= $this->image("temp-profile.png", "Temperature profile") ?>
