...
<?= $this->image("lab-view.jpg", "My workbench and lab space") ?>
...
<?= $this->image("datasheet.png", "Datasheet open") ?>
...
<?= $this->image("datasheet-folder.png", "Datasheets") ?>

<?= $this->image("folders.png", "Folders") ?>
...
<?= $this->image("parts-list.png", "Parts list") ?>
