<?php
$post = array(
	'title' => 'Using a HPC on a Daily Basis'
);
?>
...
<?= blog_image("lab-view.jpg", "My workbench and lab space") ?>
...
<?= blog_image("datasheet.png", "Datasheet open") ?>
...
<?= blog_image("datasheet-folder.png", "Datasheets") ?>

<?= blog_image("folders.png", "Folders") ?>
...
<?= blog_image("parts-list.png", "Parts list") ?>
