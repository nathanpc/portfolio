...
<?= $this->image("mini12.jpg", "The finished project") ?>
...
<p>I also designed a <a href="<?= $this->asset('peak-detector.png') ?>">very simple peak detector</a> to detect any clipping on the output to make sure the signal was as clean as possible, but, sadly, my case was so small that I couldn't fit it in. Since it would be powered from 2 18650 packs (3 cells each) or a pair of 9V batteries, the <a href="<?= $this->asset('power-supply.png') ?>">power supply</a> is extremely simplistic.</p>

<p>When all of the parts arrived, I decided to get everything prepared to be assembled the next day.</p>

<?= $this->image("pre-assembly.jpg", "All the parts needed to built it have been collected") ?>
...
<?= $this->image("drilling.jpg", "Holes drilled in the case and panel components test fitted") ?>
...
<?= $this->image("protoboard.jpg", "All PCB components soldered") ?>
...
<?= $this->image("more-jacks.jpg", "Started soldering the panel mount components") ?>
...
<?= $this->image("finished.jpg", "All finished up and ready for testing") ?>
...
<?= $this->image("testing.jpg", "Testing the amplifier on my living room") ?>
